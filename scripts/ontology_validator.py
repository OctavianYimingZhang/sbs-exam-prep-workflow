...
ID_FIELDS = {
    ...
    "AtomicKnowledgeLedger": "ledger_id",
    "AtomicKnowledgeUnit": "unit_id",
    "SourceBaselineNotesPlan": "baseline_plan_id",
    "KnowledgeOnlyStudentView": "view_id",
    "ExamOverlayPass": "overlay_id",
    "PublicOutputPoint": "point_id",
    "PublicPointBlock": "block_id",
    "OutputLanguageProfile": "profile_id",
    "RouteDocxStyleProfile": "style_profile_id",
    "RenderDecision": "decision_id",
    "PointCoverageBinding": "binding_id",
...
FILE_TYPE_HINTS = {
    ...
    "atomic_knowledge_ledgers": "AtomicKnowledgeLedger",
    "atomic_knowledge_units": "AtomicKnowledgeUnit",
    "source_baseline_notes_plans": "SourceBaselineNotesPlan",
    "knowledge_only_student_views": "KnowledgeOnlyStudentView",
    "exam_overlay_passes": "ExamOverlayPass",
    "public_output_points": "PublicOutputPoint",
    "public_point_blocks": "PublicPointBlock",
    "output_language_profiles": "OutputLanguageProfile",
    "route_docx_style_profiles": "RouteDocxStyleProfile",
    "render_decisions": "RenderDecision",
    "point_coverage_bindings": "PointCoverageBinding",
